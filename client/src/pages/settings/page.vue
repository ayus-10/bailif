...
const notificationPrefs = reactive([
    {
        key: "comments",
        label: "Comments",
        hint: "New comments on tasks and documents",
        enabled: true,
    },
    {
        key: "assignments",
    ...
    },
    {
        ...
        hint: "Tasks due within 24 hours",
        enabled: true,
    },
    {
        key: "digest",
        label: "Weekly digest",
        hint: "Summary email every Monday",
        enabled: false,
    },
]);
